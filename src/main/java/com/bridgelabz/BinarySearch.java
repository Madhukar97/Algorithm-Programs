...
public class BinarySearch {
     ...
     *
     * @param arr takes in the given string array
     * @param x   takes in the element need to be searched in the array
     * @return Returns index of x if it is present in arr[], else return -1
     */
